...
| [Recorrido rápido: secuencias de comandos de ajuste/uso](https://github.com/smartiden/Smart-Transformers/tree/main/examples) | Scripts de ejemplo para ajustar modelos en una amplia gama de tareas |
