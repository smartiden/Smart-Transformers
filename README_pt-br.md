...
| [Tour Rápido: Scripts de Ajuste Fino/Utilização](https://github.com/smartiden/Smart-Transformers/tree/main/examples) | Scripts de exemplo para ajuste fino de modelos em uma ampla gama de tarefas |
