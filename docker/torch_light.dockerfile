...
RUN uv pip install  --no-cache-dir "transformers[sklearn,torch,testing,sentencepiece,torch-speech,vision,timm]"  'pip>=21.0.0' 'setuptools>=49.6.0' 'pip[tests]' 'scikit-learn' 'torch-stft' 'nose' 'accelerate' 'dataset'
